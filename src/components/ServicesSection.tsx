...
const ServiceCard = ({ s, i }: { s: typeof services[0]; i: number }) => {
  ...
  return (
    ...
    >
      <div
        className={`group relative bg-dark-3 border rounded-2xl p-8 transition-all duration-300 overflow-hidden hover:-translate-y-[7px] ${
          s.gold
      ...
      >
        ...
        <a
          ...
          className={`inline-flex items-center gap-[7px] text-[13px] font-bold transition-all duration-[250ms] hover:gap-3 ${
