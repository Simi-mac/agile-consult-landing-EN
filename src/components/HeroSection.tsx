...
import { trackCtaAgendarDiagnostico, trackCtaConhecerServicos } from "@/analytics";
    ...
    <section className="relative flex items-center min-h-[100svh] sm:min-h-[600px] md:h-[80vh] md:min-h-[560px] pt-24 sm:pt-24 md:pt-28 pb-12">
      ...
      <div className="container relative z-10" style={{ isolation: "isolate" }}>
        <div className="max-w-3xl">
          ...
          >
            {t("hero.title_pre")}{" "}
            <span className="text-primary">{t("hero.title_hl1")}</span> {t("hero.title_mid")}{" "}
            <span className="text-secondary">{t("hero.title_hl2")}</span>
          </h1>
          ...
          >
            <a
              ...
              onClick={() => trackCtaAgendarDiagnostico('hero')}
            ...
            <a
              href="#servicos"
              onClick={() => trackCtaConhecerServicos('hero')}
