    ...
    <section className="relative h-[80vh] min-h-[560px] flex items-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl">
          ...
          <motion.h1
            className="font-display font-extrabold text-[clamp(2.4rem,4.5vw,3.8rem)] leading-[1.05] tracking-[-2px] mb-5"
            initial={{ opacity: 0, y: 28 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="text-[17px] text-gray-2 leading-relaxed max-w-[540px] mb-8"
            initial={{ opacity: 0, y: 28 }}
            animate={{ opacity: 1, y: 0 }}
